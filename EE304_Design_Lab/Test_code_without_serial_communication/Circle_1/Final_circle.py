...
with open("copper_top_circle.gbr","r") as input:
    with open("circle1.txt","w") as output: 
        for line in input:
            for p in line:
                if p =='X':
                    output.write(line)
                    ...
                    break            
for i, line in enumerate(fileinput.input('circle1.txt', inplace=1)):
