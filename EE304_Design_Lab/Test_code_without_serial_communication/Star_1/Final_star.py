...
import csv
import math
with open("copper_top_star.gbr","r") as input:
    with open("star1.txt","w") as output: 
        for line in input:
            for p in line:
                if p =='X':
                    output.write(line)
                    ...
                    break            
for i, line in enumerate(fileinput.input('star1.txt', inplace=1)):
